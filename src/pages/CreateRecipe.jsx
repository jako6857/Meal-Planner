...
const copy = {
  ...
  da: {
    ...
    signInFirst: "Log ind først for at tilføje dine egne opskrifter.",
    goSignIn: "Gå til log ind",
    recipeTitle: "Opskriftstitel",
    category: "Kategori (fx Morgenmad)",
    cuisine: "Køkken (fx Amerikansk)",
    recipeImage: "Opskriftsbillede",
    chooseGallery: "Vælg fra galleri",
    takePhoto: "Tag billede",
    uploading: "Uploader billede...",
    manualImage: "Eller indsæt billed-URL manuelt",
    instructions: "Sådan laver du den",
    ingredients: "Ingredienser (en per linje)\nÆg - 2\nMælk - 200 ml",
    saving: "Gemmer...",
    saveRecipe: "Gem opskrift",
    mustSignIn: "Du skal være logget ind for at oprette opskrifter.",
    invalidImage: "Vælg en gyldig billedfil.",
    uploadFailedPrefix: "Upload af billede fejlede:",
    uploadFailedSuffix: "Sørg for at storage-bucket 'recipe-images' findes og tillader upload for loggede brugere.",
    previewAlt: "Forhåndsvisning af opskrift",
  },
}
